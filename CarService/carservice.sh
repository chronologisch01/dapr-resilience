...
#dapr run --app-id carservice --app-port 8085 --enable-app-health-check --config ../config.yaml --components-path ../Components/ -- java -jar ./target/CarService-0.0.1-SNAPSHOT.jar --server.port=8085 &
#dapr run --app-id carservice --app-port 8081 --enable-app-health-check --config ../config.yaml --components-path ../Components/ -- java -jar ./target/CarService-0.0.1-SNAPSHOT.jar --server.port=8081
